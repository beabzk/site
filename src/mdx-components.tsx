...
export const components: MDXComponents = {
  ...
  blockquote: ({ children, ...props }) => (
    <blockquote
      className="my-6 rounded-r-lg border-l-4 border-[var(--accent-primary)] bg-gray-900/50 py-4 pl-4 text-gray-300 italic"
      {...props}
    >
      {children}
    </blockquote>
  ...
  a: ({ children, href, ...props }) => (
    <a
      href={href}
      className="text-[var(--accent-primary)] underline transition-colors hover:opacity-80"
...
export function useMDXComponents(currentComponents: MDXComponents): MDXComponents {
  return {
    ...currentComponents,
    ...components,
  };
